...
extension PackageConfig {
	...
	func write(adapter: TypePreservingCodingAdapter) {
	...
	static func debugLog(_ message: String) -> Void {
	...
	static func read(adapter: TypePreservingCodingAdapter) -> PackageConfig? {
		let fileManager = FileManager.default
	...
	static func runXCRun(tool: String) -> String {
		let proc = Process()
	...
	static func getSwiftPMManifestArgs(swiftPath: String) -> [String] {
	...
	static func getLibPackageConfigPath() -> String? {
		let fileManager = FileManager.default
	...
	static func getPackageConfigArgs() -> [String] {
